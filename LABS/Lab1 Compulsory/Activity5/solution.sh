...
openssl ec -in private-secp256k1.key -pubout -out public-secp256k1.key

openssl ec -in private.key -pubout -out public-secp256k1.key
# cat public.key

openssl pkeyutl -derive -out sharedKey.pem -inkey private-secp256k1.key -peerkey public.key 
# cat sharedKey.pem

openssl enc -aes-256-ctr -base64 -k $(base64 sharedKey.pem) -iv 102030506070ddff -d -in cipher.txt -out flags.txt
